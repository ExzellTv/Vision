...
const CONVERSATIONS = [
  {
    ...
    initials: "HC",
    lastMessage: "We'd love to schedule a site visit to discuss your project.",
    time: "2m ago",
    unread: 2,
    online: true,
  },
  {
    ...
    initials: "DU",
    lastMessage: "The preliminary cost estimate is ready for review.",
    time: "1h ago",
    unread: 0,
    online: true,
  },
  {
    ...
    initials: "PH",
    lastMessage: "Thank you for your interest! Let me know if you have questions.",
    time: "Yesterday",
    unread: 0,
    online: false,
  },
...
export default function Chat() {
  ...
  const [selectedConversation, setSelectedConversation] = useState(
    builderFromBrowse ? { id: "new", name: builderFromBrowse.name, initials: builderFromBrowse.initials } : CONVERSATIONS[0]
  );
  ...
  useEffect(() => {
    if (builderFromBrowse && selectedConversation?.id === "new") {
      setMessages([
        {
          id: 1,
          role: "system",
          content: `Starting new conversation with ${builderFromBrowse.name}`,
        },
        {
          id: 2,
          role: "assistant",
          content: `Hi! Thanks for reaching out to ${builderFromBrowse.name}. I'm here to help answer any questions about our services. We specialize in ${builderFromBrowse.specialty.toLowerCase()} and have completed ${builderFromBrowse.projectsCompleted} projects in the Dallas area. How can I assist you today?`,
        },
      ]);
    } else {
      setMessages([
        {
          id: 1,
          role: "assistant",
          content: `Hi! This is ${selectedConversation?.name}. How can we help you with your project today?`,
        },
      ]);
    }
  }, [selectedConversation, builderFromBrowse]);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const responses = [
        ...
        "I'd be happy to help with that. Could you provide a bit more detail about your timeline?",
        "We have availability to discuss this further. Would you like to schedule a consultation?",
        "Based on your requirements, I think we could put together a preliminary estimate. Let me get some details.",
      ];
      const aiMessage = {
        id: Date.now() + 1,
        role: "assistant",
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, overflowY: "auto" }}>
          {/* New conversation from browse */}
          {builderFromBrowse && (
            <div
              onClick={() => setSelectedConversation({ id: "new", name: builderFromBrowse.name, initials: builderFromBrowse.initials })}
              style={{
                display: "flex",
                gap: 12,
                padding: "16px 20px",
