  ...
  return (
    <div style={{ height: "100%", background: colors.bgGradient, display: "flex", flexDirection: "column", overflow: "hidden", boxSizing: "border-box" }}>
      ...
      <div style={{ flex: isMobile ? "none" : `${100 - topPct} 1 0`, minHeight: isMobile ? "auto" : 0, display: "flex", flexDirection: "column", overflow: isMobile ? "visible" : "hidden", borderTop: isMobile ? `1px solid ${colors.cardBorder}` : "none" }}>
        ...
        <div style={{ flex: 1, minHeight: isMobile ? "auto" : 0, overflowY: isMobile ? "visible" : "auto", overflowX: isMobile ? "auto" : "hidden", padding: "0 12px" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 1, minWidth: isMobile ? 600 : "auto" }}>
            {schedule.map((ph) => {
              const sw       = weeksBetween(projectStart, ph.startDate);
